...
if __name__ == "__main__":
    ...
    _start_offset = 0
    _video_file_path = "/home/sumit/Desktop/postManagementService/DataNext/src/python/social/socialHubIntegrationService/multimedia/video.mp4"  # Replace with the actual path to your video file
