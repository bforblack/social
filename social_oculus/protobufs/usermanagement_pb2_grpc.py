...
class oculusUserManagementStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.addPlatform = channel.unary_unary(
                '/usermanagement.oculusUserManagement/addPlatform',
                request_serializer=usermanagement__pb2.platformRequest.SerializeToString,
                response_deserializer=usermanagement__pb2.platformResponce.FromString,
                )
...
def add_oculusUserManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'addPlatform': grpc.unary_unary_rpc_method_handler(
                    servicer.addPlatform,
                    request_deserializer=usermanagement__pb2.platformRequest.FromString,
                    response_serializer=usermanagement__pb2.platformResponce.SerializeToString,
            ),
...
class oculusUserManagement(object):
    ...
    def addPlatform(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/usermanagement.oculusUserManagement/addPlatform',
            usermanagement__pb2.platformRequest.SerializeToString,
            usermanagement__pb2.platformResponce.FromString,
